...
import { pool } from '../db/db.js'; // Assicurati che il percorso sia corretto
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    // Controlla che il turno appartenga a uno dei veicoli dell'autista
