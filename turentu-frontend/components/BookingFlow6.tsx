                  ...
                  <Elements stripe={stripePromise}>
                    <StepPagamento
                      ...
                      slots={risultatiSelezionati.map(r => ({
                        ...
                        start_datetime: r.oraPartenza
                          ? new Date(r.oraPartenza).toISOString()
                          : datetime,
                        durata: r.durataMs ? Math.floor(r.durataMs / 1000) : 0,
                        ...
                        localitaOrigine: r.origine?.nome ?? localitaOrigine,
                        localitaDestinazione: r.destinazione?.nome ?? localitaDestinazione,
                      }))}
