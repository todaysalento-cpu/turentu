...
export default function CorseGiornata({ corse = [], onToggleCorsa, loadingId }: CorseGiornataProps) {
  ...
  // minuti dalla partenza: negativo se la corsa era prevista prima dell'ora attuale
