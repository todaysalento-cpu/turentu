...
const corsaCompatibile = { id: 1, tipo_corsa: 'condivisa', prezzo: 10 };
...
async function testBooking() {
  ...
  try {
    ...
    console.log('✅ Prenotazione diretta:', {
      ...pren,
      pagamentoClientSecret: pren.pagamento.stripePaymentIntentClientSecret
    });
  } catch (err) {
  ...
  try {
    ...
    console.log('✅ Pending slot libero:', {
      ...pending,
      pagamentoClientSecret: pending.pagamento?.stripePaymentIntentClientSecret
    });
  } catch (err) {
