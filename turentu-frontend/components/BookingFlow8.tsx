...
export default function BookingFlow({
  ...
  // 🔹 Prepara slot con coordinate + indirizzi + fallback
  const preparedSlots: Slot[] = risultatiSelezionati.map(r => ({
    ...
    durata_minuti: r.durataMinuti ?? Math.floor((r.durataMs ?? 1800000) / 60000), // default 30 min
    ...
    localitaOrigine: r.origine?.nome ?? localitaOrigine ?? "Piazza Duomo, Milano",
    localitaDestinazione: r.destinazione?.nome ?? localitaDestinazione ?? "Corso Vittorio Emanuele II, Milano",
  }));
