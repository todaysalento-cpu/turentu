            ...
            <div className="flex justify-between items-start mb-1">
              <div className="grid grid-cols-[auto_auto_auto] items-center gap-x-1.5">
                ...
                <span className="font-bold text-sm text-zinc-700 dark:text-zinc-300">
                  {r.localitaOrigine ?? "N/D"}
                </span>
                <span></span>
                <span className="font-bold text-sm text-zinc-700 dark:text-zinc-300">
                  {r.localitaDestinazione ?? "N/D"}
                </span>
              ...
              <div className="font-bold text-lg ml-4 flex-shrink-0 leading-none text-[#ff3036]">
