...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log("BODY FETCH:", bodyToSend);
...
// 🔹 Riapre il form quando premi "Modifica ricerca"
...
<BookingFlow
  ...
  clienteId={user.id}
  coordOrigine={form.localitaOrigine?.coord}        // ✅ passa le coordinate
  coordDestinazione={form.localitaDestinazione?.coord} // ✅ passa le coordinate
/>
