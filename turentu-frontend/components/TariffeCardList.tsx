...
// Ordine fisso
const tipiOrdine: Tariffa['tipo'][] = ['standard', 'notturna', 'festivo'];
        ...
        <div className="flex flex-col gap-1 text-xs">
          ...
          <div className="flex gap-1 font-medium text-gray-600 items-center text-[9px]">
            ...
            <div className="min-w-[70px] flex justify-center">
              <span className={`bg-green-100 text-green-800 text-[8px] px-1 rounded-full font-semibold`}>Stimato</span>
            </div>
          </div>
