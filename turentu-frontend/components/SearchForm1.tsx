...
import BottomSheetCalendario from "./BottomSheetCalendario"; // <- nuovo
  ...
  const MobileForm = (
    <div className="w-full max-w-[1280px] mx-auto flex flex-col gap-4 p-4 relative">
      ...
      <AppInput
        ...
        value={form.start_datetime ? formatReadableDate(form.start_datetime) : ""}
              ...
              <div className="flex-1 overflow-y-auto space-y-4">
                ...
                {activeInput === "data" && (
                  <BottomSheetCalendario
                    value={form.start_datetime ?? new Date().toISOString().slice(0,16)}
                    onChange={(iso) => {
...
/* ================= DATE FORMAT ================= */
export const formatReadableDate = (iso: string) => {
