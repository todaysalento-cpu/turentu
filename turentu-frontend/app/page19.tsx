...
export default function RicercaPage() {
  const { user } = useUser(); // 🔹 ora usiamo il contesto per clienteId
...
{isMobile && (
  <>
    {isMobile && !bookingOpen && mobileView === "results" && (
      <HeaderMobile
    ...
    {mobileView === "form" ? (
      <div className="flex flex-col gap-3 p-4 mt-16">
        ...
        <div className="relative h-[64px]">
          ...
          <input
            ...
            className="w-full h-full pl-10 pr-2 rounded border border-gray-300 py-4"
          />
        </div>
      ...
      <div className="flex-1 relative mt-16">
        ...
        {/* PULSANTI SEMPRE VISIBILI SE C'E' SELEZIONE */}
...
{bookingOpen && risultatiSelezionati.length > 0 && user ? (
  <BookingFlow
    ...
    localitaOrigine={form.localitaOrigine}
    localitaDestinazione={form.localitaDestinazione}
    datetime={form.start_datetime}
    posti={form.posti_richiesti}
    clienteId={user.id} // ID reale dell'utente loggato
  />
