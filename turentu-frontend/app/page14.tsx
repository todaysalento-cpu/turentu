      ...
      {isMobile ? (
        <>
          {mobileView === "results" && (
            <HeaderMobile
              view={mobileView}
              onEditSearch={() => setMobileView("form")} // freccia torna al form
...
<div className="relative h-[64px]">
  ...
  {/* Pulsante fisso "Prenota/Richiedi" */}
      ...
      />
        ...
        <div className="flex flex-col gap-4 max-w-[1280px] mx-auto p-4">
          ...
          <form onSubmit={handleSubmit} className="flex gap-3 items-end">
            {/* ... input origine/destinazione/data/posti ... */}
          </form>

          {/* Tabs filtro (solo Liberi/Prenotabili) */}
          {risultati.length > 0 && (
