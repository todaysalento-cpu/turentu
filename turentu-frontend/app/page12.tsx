...
interface Risultato {
  ...
  prezzo?: number;
  modello: string;
  stato?: string[]; // "libero" o "prenotabile"
}
...
function HeaderMobile({
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-20 bg-white border-b border-gray-200 flex flex-row items-center justify-between py-3 px-4">
