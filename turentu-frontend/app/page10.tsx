...
export default function RicercaPage() {
  ...
  return (
    <div className="w-full min-h-screen p-4 flex flex-col gap-4">
      ...
      {/* ---------- FORM ----------- */}
      <form onSubmit={handleSubmit} className="w-full max-w-[1280px] mx-auto flex flex-col md:flex-row gap-3 items-stretch">

        {/* Origine */}
       <div className="relative flex-1 h-[64px] md:h-[52px]">
          ...
          <input
            ...
            className="w-full h-full pl-10 pr-2 rounded border border-gray-300 focus:border-[#ff3036]
             py-4 md:py-2 text-base md:text-sm"
        ...
        <div className="relative flex-1 h-[52px]">
          ...
          {/* Mobile */}
          <input
            className="w-full h-full pl-8 pr-2 rounded border border-gray-300 cursor-pointer md:hidden py-4 text-base"
            readOnly
          ...
          {/* Desktop */}
          <input
            className="w-full h-full pl-8 rounded border border-gray-300 hidden md:block cursor-pointer"
            readOnly
            value={formatReadableDate(form.start_datetime)}
